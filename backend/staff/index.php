		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<a href="<?php echo ADMIN_URL;?>/staff/add.php" class="btn green">
                    ...
                    <form name="form1" method="post" action="<?php echo ADMIN_URL;?>/staff/DB.php?FLAG=DELSELECT">
					...
					if (count($results)>0)
					{
						  for ($index = 0; $index < count($results); $index++) 
						  {
							  ...
							  $img = UPLOAD_URL.STAFF_THUMB_IMG.$rows['image'];
                   		?>
                        <tr class="<?php echo (($index+1)%2==0)? 'even':'odd' ?> gradeX">
                            ...
                            <td>                            	
                                <a href="<?php echo ADMIN_URL;?>/staff/edit.php?id=<?php echo $rows['id'];?>" class="btn default btn-xs purple"><i class="fa fa-edit"></i> Edit </a>&nbsp;<a href="<?php echo ADMIN_URL;?>/staff/DB.php?id=<?php echo $rows['id']; ?>&FLAG=DELETE" class="dellink btn default btn-xs purple"><i class="fa fa-trash-o"></i> Delete </a>
                            </td>
                        </tr>
                    <?php 
						  }
