                        ...
                        <form id="myForm" name="myForm" method="post" action="<?php echo ADMIN_URL;?>/admins/DB.php" class="form-horizontal">
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" placeholder="User Name" name="txtuser" id="txtuser" value="" data-required="1">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group">
                                            ...
                                            <input type="email" class="form-control" placeholder="Email Address" name="txtemail" id="txtemail" value="" data-required="1">
                                        </div>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    * </span>
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="txtfname" id="txtfname" data-required="1" class="form-control">
                                    </div>
                                </div>                                
								...
								<div class="form-group">
                                    ...
                                    * </span>
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="txtlname" id="txtlname"  data-required="1" class="form-control">
                                    </div>
                                </div>                                
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                            ...
                                            <span class="help-block">Must match 'password'</span>
                                    </div>
                                </div>
