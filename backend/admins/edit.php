			...
			<div class="row">
				<div class="col-md-12">
                    ...
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form id="myForm" name="myForm" method="post" action="<?php echo ADMIN_URL;?>/admins/DB.php" class="form-horizontal">
                            <div class="form-body">
                                <div class="form-group">
                                    <label class="col-md-3 control-label">User Name<span class="required" aria-required="true">*</span></label>
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" placeholder="User Name" name="txtuser" id="txtuser" value="<?php echo stripslashes($result['username']); ?>" data-required="1">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group">
                                            ...
                                            <input type="email" class="form-control" placeholder="Email Address" name="txtemail" id="txtemail" value="<?php echo $result['email']; ?>" data-required="1">
                                        </div>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    * </span>
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="txtfname" id="txtfname" data-required="1"  value="<?php echo $result['first_name']; ?>" class="form-control">
                                    </div>
                                </div>                                
								...
								<div class="form-group">
                                    ...
                                    * </span>
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="txtlname" id="txtlname"  data-required="1" value="<?php echo $result['last_name']; ?>" class="form-control">
                                    </div>
                                </div>                                
								...
								<div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <select class="form-control" name="status" id="status">
                                            ...
                                            <option value="super admin" <?php echo ($result['status']=='super admin')?'selected':'';?> >Super Admin</option>
                                            <?php }else{?>
                                            <option value=''>Select User Type</option>
                            				<option value="admin" <?php echo ($result['status']=='admin')?'selected':'';?>>Admin</option>
                                            <?php }?>
                                        </select>
                                    </div>
                                </div>                                
                                ...
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-4">
                                       ...
                                       <input name="id" type="hidden" value="<?php echo $_REQUEST['id'];?>" />
                                        ...
                                        <button type="button" class="btn default" name="cancel" onClick="javascript: window.location.href='<?php echo ADMIN_URL;?>/admins/index.php'">Cancel</button>
                                    </div>
                                </div>
                            </div>
                        </form>
