                        ...
                        <form id="myForm" name="myForm" method="post" action="<?php echo ADMIN_URL;?>/menu_manager/DB.php" class="form-horizontal">
                            <div class="form-body">
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Parent<span class="required" aria-required="true">*</span></label>
                                    <div class="col-md-4">
                                    <?php
                                    	$tqry="SELECT * FROM menu WHERE parent_id=0"; 
										if (! $dbBean->Query($tqry)) $dbBean->Kill();
										if ($dbBean->RowCount()>0)
										{
											$trows = $dbBean->RecordsArray(MYSQLI_ASSOC);
										}
									?>
                                        <select id="parent_id" name="parent_id" class="form-control form-filter input-sm">
                                        	<?php 
											for($i = 0; $i < count($trows); $i++) 
  											{
                                                echo "<option value='".$trows[$i]['id']."'".(($trows[$i]['id']==$_REQUEST['parent_id'])?'selected':'').">".stripslashes($trows[$i]['name'])."</option>";
											}
                                            ?>
										</select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" placeholder="Option Name" name="name" id="name" value="<?php echo $rows['name']; ?>"  data-required="1">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" placeholder="Page Name" name="page_name" id="page_name" value="<?php echo $rows['page_name']; ?>"  data-required="1">
                                    </div>
                                </div>                              
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" placeholder="Order Index" name="order" id="order" value="<?php echo $rows['order_index']; ?>"  data-required="1">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" placeholder="Icon" name="icon" id="icon" value="<?php echo $rows['icon']; ?>"  data-required="1">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                         <select name="ishidden" id="ishidden" class="form-control form-filter input-sm">
                                            <option value="0" <?php echo $rows['is_hidden']=='0'? 'selected': '' ;?>>No</option>
                                            <option value="1" <?php echo $rows['is_hidden']=='1'? 'selected': '' ;?>>Yes</option>
                                          </select>    
                                    </div>
                                </div>
                            </div>
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-4">
                                    	<input type="hidden" name="FLAG" value="EDIT_MENU_OPTION" />
