                        ...
                        <form id="myForm" name="myForm" method="post" action="<?php echo ADMIN_URL;?>/menu_manager/DB.php" class="form-horizontal">
                            <div class="form-body">
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Group Name<span class="required" aria-required="true">*</span></label>
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" placeholder="Group Name" name="name" id="name" value="<?php echo stripslashes($rows['name']); ?>" data-required="1">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3">Show In Top Menu</label>
                                    <div class="col-md-4">
                                         <select name="dashboard" id="dashboard" class="form-control form-filter input-sm">
                                            <option value="1" <?php echo $rows['is_dashboard_icon']=='1'? 'selected': '' ;?>>Yes</option>
                                            <option value="0" <?php echo $rows['is_dashboard_icon']=='0'? 'selected': '' ;?>>No</option>
                                          </select>    
                                    </div>
                                </div>
                            </div>
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-4">
                                    	<input type="hidden" name="FLAG" value="EDIT_GROUP" />
                                        <input name="id" type="hidden" value="<?php echo $_REQUEST['id'];?>" />
                                        <button type="submit" class="btn green">Submit</button>
                                        <button type="button" class="btn default" name="cancel" onClick="javascript: window.location.href='<?php echo ADMIN_URL;?>/menu_manager/index.php'">Cancel</button>
                                    </div>
                                </div>
                            </div>
                        </form>
