						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<a href="<?php echo ADMIN_URL;?>/menu_manager/add_submenu.php?parent_id=<?php echo $_REQUEST['parent_id'];?>" class="btn green">
                            ...
                            <form name="form1" method="post" action="<?php echo ADMIN_URL;?>/menu_manager/DB.php?FLAG=DELSELECT_SUBMENU">
							...
							<tbody>
                    <?php	
									  $results=Menu::getMenuOptions($_REQUEST['parent_id']);
                   ...
                   ?>
                                        <tr class="<?php echo (($index+1)%2==0)? 'even':'odd' ?> gradeX">
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo ADMIN_URL;?>/menu_manager/edit_submenu.php?id=<?php echo $rows['id'];?>&parent_id=<?php echo $_REQUEST['parent_id'];?>" class="btn default btn-xs purple"><i class="fa fa-edit"></i> Edit </a>
                                                <a href="<?php echo ADMIN_URL;?>/menu_manager/DB.php?id=<?php echo $rows['id']; ?>&FLAG=DELETE_SUBMENU" class="dellink btn default btn-xs purple"><i class="fa fa-trash-o"></i> Delete </a>
