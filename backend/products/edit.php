				...
				<div class="col-md-12">
                    ...
                    <div class="portlet-body form">
                       ...
                       ?>
                        ...
                        <form id="frmproduct" name="frmproduct" method="post" action="<?php echo ADMIN_URL;?>/products/DB.php" class="form-horizontal">
                            <div class="form-body">           
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                         <select name="category" id="category" class="form-control">
	                                    	...
	                                    	<?php
	                                    	$results=Product::getServicecategory();
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-4">
                                    	<input type="hidden" name="FLAG" value="EDIT_PRODUCT" />
                                        <input name="id" type="hidden" value="<?php echo $_REQUEST['id'];?>" />                                        
                                        <button type="submit" class="btn green">Submit</button>
                                        <button type="button" class="btn default" name="cancel" onClick="javascript: window.location.href='<?php echo ADMIN_URL;?>/products/index.php'">Cancel</button>
                                    </div>
                                </div>
                            </div>
                        </form>
