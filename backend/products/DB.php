<?php
	...
	if (isset($_REQUEST['FLAG']) && $_REQUEST['FLAG'] == 'DELSELECT') {		
		...
		foreach ($delete as $id) 
		{
			...
			$val = $Product->deleteProduct($fieldvalues,$cond);
		
			$general->addLogAction($_SESSION['adm_user_id'], 'Deleted', (int)$id,'Product Management', $_SESSION['adm_status']);
		}
