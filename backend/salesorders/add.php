			...
			<div class="row">
				<div class="col-md-12">
                    ...
                    <div class="portlet-body form">
                       ...
                       ?>
                        <!-- BEGIN FORM-->
                        <form id="frmsales" name="frmsales" method="post" action="<?php echo ADMIN_URL;?>/salesorders/DB.php" class="form-horizontal">
                            <div class="form-body">                            	
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                         <select name="product" id="product" class="form-control" onchange="javascript:fun_checkstock(this.value);">
                                    		<option value="">Select Product</option>
	                                    	<?php
	                                    	$results=Salesorder::getProducts();
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-4">
                                    	<input type="hidden" name="FLAG" value="ADD_SALES" />
                                    	<input type="hidden" name="vouchertype" id="vouchertype" value="1" />
                                        <button type="submit" class="btn green">Submit</button>
                                        <button type="button" class="btn default" name="cancel" onClick="javascript: window.location.href='<?php echo ADMIN_URL;?>/salesorders/index.php'">Cancel</button>
                                    </div>
                                </div>
                            </div>
                        </form>
...
function fun_checkstock(a)
{
	$("#divmsg").load("<?php echo ADMIN_URL;?>/salesorders/DB.php?FLAG=GET_STOCK&id="+a,function(data){
		
		if (data == 'error') {
			$("#divmsg").html("Stock not available for this product");
		} else {
			$("#divmsg").html("");
		}			
	});
