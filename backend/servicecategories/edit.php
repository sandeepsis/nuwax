				...
				<div class="col-md-12">
                    ...
                    <div class="portlet-body form">
                       ...
                       ?>
                        ...
                        <form id="frmservicecat" name="frmservicecat" method="post" action="<?php echo ADMIN_URL;?>/servicecategories/DB.php" enctype="multipart/form-data" class="form-horizontal">
                            <div class="form-body">           
                                <div class="form-group">
                                    <label class="control-label col-md-3">Category Name<span class="required" aria-required="true">*</span></label>
                                    <div class="col-md-4">
                                         <input type="text" class="form-control" placeholder="Category Name" name="categoryname" id="categoryname" value="<?php echo stripslashes($rows->categoryname); ?>"/>    
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                         <input type="file" name="categoryimg" id="categoryimg" /> 
                                         <input type="hidden" name='hdncatimg' id="hdncatimg" value="<?php echo $rows->image;?>"/>    
                                    </div>
                                    <div class="col-md-3"> 
                                         <img src="<?php echo UPLOAD_URL.SERVICECAT_THUMB_IMG.$rows->image;?>" alt=''/>    
                                    </div>
                                </div>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-4">
                                    	<input type="hidden" name="FLAG" value="EDIT_SERVICECAT" />
                                        <input name="id" type="hidden" value="<?php echo $_REQUEST['id'];?>" />                                        
                                        <button type="submit" class="btn green">Submit</button>
                                        <button type="button" class="btn default" name="cancel" onClick="javascript: window.location.href='<?php echo ADMIN_URL;?>/servicecategories/index.php'">Cancel</button>
                                    </div>
                                </div>
                            </div>
                        </form>
